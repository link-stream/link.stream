...
class Instagram_api {
    ...
    function instagramLogin() {
        ...
        return 'https://api.instagram.com/oauth/authorize?app_id=' . $this->codeigniter_instance->config->item('instagram_client_id') . '&redirect_uri=' . $this->codeigniter_instance->config->item('instagram_callback_url') . '&scope=user_profile,user_media&response_type=code';
    }
...
// Return the response
    ...
    function getUserInfo($user_id, $fields, $access_token) {
        ...
        $authorization_url = 'https://graph.instagram.com/' . $user_id . '?fields=' . $fields . '&access_token=' . $access_token;
