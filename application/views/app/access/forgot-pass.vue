    ...
    <div>
        ...
        <div class="container">
            <q-card-section class="row justify-center social-sign-up-options">                      
              ...
              <div class="row justify-center enter-email">Enter the email address you used at sign up and we’ll send you password reset instructions.</div>  
            </q-card-section>                      
        </div>   
        <q-card-section class="col col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 card-forgot q-mt-lg">
