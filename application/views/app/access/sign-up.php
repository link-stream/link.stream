                            ...
                            <q-card-section class="q-pa-none">
                                <div>
                                    ...
                                    <div class="row justify-center">                                    
                                        <q-input class="q-ma-none q-pa-none forminput" v-model="username" outlined square bg-color="white" dense />
                                    </div>
                                </div>
                                <div class="q-mt-md">
                                ...
                                <div class="q-mt-md">
                                    ...
                                    <div class="q-mt-xs row justify-center">                                    
                                        <q-input class="q-ma-none q-pa-none forminput" v-model="rpassword" outlined square bg-color="white" dense type="password" />
                                    </div>
                                </div> 
