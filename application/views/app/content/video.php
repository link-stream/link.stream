                                                    ...
                                                    <div class="d-flex flex-column text-center">
                                                        <div class="col-md-6 form-group mb-3 m-auto">
                                                            ...
                                                            <select class="form-control" id="radio" name="radio">
                                                                ...
                                                                <option value="5"<?= ($type == '5' ? 'selected=""' : '') ?>>TikTok</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card mb-5">
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 ">
                                                            <a href="<?= base_url() ?>app/video" class="btn btn-success m-1 js-content" type="button">Add New Video Content</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
