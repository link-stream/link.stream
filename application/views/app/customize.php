            ...
            <div class="main-content">
                ...
                <div class="card user-profile o-hidden mb-4">
                    ...
                    <div class="user-info"><img class="profile-picture avatar-lg mb-2" src="<?= HTTP_ASSETS ?>dist-assets/images/faces/1.jpg" alt="" />
                        ...
                        <p class="text-muted m-0">The Hip Hop Master</p>
                    </div>
                    <div class="card-body">
                        <ul class="nav nav-tabs profile-nav mb-4" id="profileTab" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="timeline-tab" data-toggle="tab" href="#timeline" role="tab" aria-controls="timeline" aria-selected="false">Avatar & Banner</a></li>
                            <li class="nav-item"><a class="nav-link" id="about-tab" data-toggle="tab" href="#about" role="tab" aria-controls="about" aria-selected="true">Personal Information</a></li>
