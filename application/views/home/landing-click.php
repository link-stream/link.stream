...
<head>
    ...
    <!-- Stylesheets
    ============================================= -->
    <link href="<?= HTTP_ASSETS ?>css/external.css" rel="stylesheet">
            ...
            <nav id="primary-menu" class="navbar navbar-expand-lg navbar-dark">
                <div class="container">
                    <a class="navbar-brand" href="index.html">
                        <img class="logo logo-dark" src="<?= HTTP_ASSETS ?>images/logo/logo-dark.png" alt="Kolaso Logo">
                    </a>
        ...
        <section id="hero" class="section hero">
            <div class="container">
                <div class="row row-content">
                        ...
                        <div class="hero-action">
                            ...
                            <span class="video-button">
                                <a class="popup-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4">
                                    ...
                                    <span class="btn-player"><img src="<?= HTTP_ASSETS ?>images/video/player.svg"
                    ...
                    <div class="col-12 col-md-12 col-lg-6">
                        <div class="hero-img">
                            <img class="img-fluid" src="<?= HTTP_ASSETS ?>images/hero/hero.svg" alt="background">
                        </div>
                    </div>
                </div>
                <!-- .row end -->
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="feature-panel">
                            <div class="feature-img bg-blue">
                                <img src="<?= HTTP_ASSETS ?>images/features/champion.svg" alt="target">
                            </div>
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="feature-panel">
                            <div class="feature-img bg-green">
                                <img src="<?= HTTP_ASSETS ?>images/features/team.svg" alt="users">
                            </div>
                            <div class="feature-content">
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="feature-panel">
                            <div class="feature-img bg-orange">
                                <img src="<?= HTTP_ASSETS ?>images/features/chart.svg" alt="chart">
                            </div>
                            <div class="feature-content">
...
============================================= -->
        <section id="feature2" class="section feature feature-2 bg-shape">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-6">
                        <img class="img-fluid" src="<?= HTTP_ASSETS ?>images/features/service-1.svg" alt="device" />
                    </div>
                    <!-- .col-md-6 end -->
                    <div class="col-12 col-md-12 col-lg-5 offset-lg-1">
                        <div class="feature-panel mt-80">
                            <div class="feature-img bg-purple">
                                <img src="<?= HTTP_ASSETS ?>images/features/bookmark.svg" alt="device">
                            </div>
                            <div class="feature-content">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 col-lg-6 offset-lg-1">
                        <img class="img-fluid pull-right" src="<?= HTTP_ASSETS ?>images/features/service-2.svg" alt="device" />
                    </div>
                    <!-- .col-md-6 end -->
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="carousel carousel-dots owl-carousel" data-slide="5" data-slide-res="2"
                            ...
                            <!-- Client #1 -->
                            <div class="client">
                                <img class="center-block" src="<?= HTTP_ASSETS ?>images/clients/1.png" alt="client">
                            </div>

                            <!-- Client #2 -->
                            <div class="client">
                                <img class="center-block" src="<?= HTTP_ASSETS ?>images/clients/2.png" alt="client">
                            </div>

                            <!-- Client #3 -->
                            <div class="client">
                                <img class="center-block" src="<?= HTTP_ASSETS ?>images/clients/3.png" alt="client">
                            </div>

                            <!-- Client #4 -->
                            <div class="client">
                                <img class="center-block" src="<?= HTTP_ASSETS ?>images/clients/4.png" alt="client">
                            </div>

                            <!-- Client #5 -->
                            <div class="client">
                                <img class="center-block" src="<?= HTTP_ASSETS ?>images/clients/5.png" alt="client">
                            </div>
                            <!-- Client #3 -->
                            <div class="client">
                                <img class="center-block" src="<?= HTTP_ASSETS ?>images/clients/3.png" alt="client">
...
============================================= -->
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="footer-logo">
                                <img src="<?= HTTP_ASSETS ?>images/logo/logo-dark.png" alt="Siena Logo">
                            </div>
                        </div>
    ...
    <script src="<?= HTTP_ASSETS ?>js/plugins.js"></script>
    <script src="<?= HTTP_ASSETS ?>js/functions.js"></script>
</body>
