<template>
    <div class="cart ckeckout-pay">
        <b-row>
            <b-col cols="8" xl="8" lg="7" md="7">
                <b-form class="pt-4 center">
                    <b-col cols="12">
                        <b-avatar
                    ...
                    <b-col cols="12" class="mt-4">
                        ...
                        <b-row>
                            <b-col cols="12">
                                <b-form-group id="input-group-4">
                                    ...
                                    >
                                        <b-form-checkbox
                                            class="keep-me-up-to-date-o"
                                            value="me"
                                            >Keep me up to date on news and
                                            exclusive offers</b-form-checkbox
                                        >
                                    </b-form-checkbox-group>
                                </b-form-group>
                            </b-col>
                        ...
                        <b-row>
                            <b-col cols="6" xl="3">
                                <b-form-group
                                    id="input-group-firstN"
                                    label="First Name"
                                    label-for="input-firstN"
                                    class="label"
                                >
                                    <b-form-input
                                        id="input-firstN"
                            ...
                            <b-col cols="6" xl="4">
                                <b-form-group
                                    id="input-group-lastN"
                                    label="Last Name"
                                    label-for="input-lastN"
                                    class="label"
                                >
                                    <b-form-input
                                        id="input-lastN"
                        ...
                        <b-row>
                            <b-button
                                pill
                                class="mt-4 ml-3 continue-to-payment"
                    ...
                    <b-col cols="7" class="mt-3">
                        <b-button variant="link" class="mr-3"
