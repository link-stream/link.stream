                                ...
                                <b-col cols="12" sm="10">
                                    ...
                                    >
                                        ...
                                        <div v-if="cardErrors.cardNumber" class="error">
                                            <small class="msg-error">{{ cardErrors.cardNumber }}</small>
                                        </div>
                                    </b-form-group>
                                </b-col>
                            </b-row>
                                ...
                                <b-col cols="6" sm="5">
                                    <b-form-group label-for="input-date">
                                        ...
                                        <div v-if="cardErrors.cardExpiry" class="error">
                                            <small class="msg-error">{{ cardErrors.cardExpiry }}</small>
                                        </div>
                                    </b-form-group>
                                </b-col>
                                <b-col cols="6" sm="5">
                                    <b-form-group label-for="input-cvc">
                                        ...
                                        <div v-if="cardErrors.cardCvc" class="error">
                                            <small class="msg-error">{{ cardErrors.cardCvc }}</small>
                                        </div>
                                    </b-form-group>
                                </b-col>
                            </b-row>
                            <b-row style="justify-content: center;">
                                <b-col cols="12" sm="10">
                                    ...
                                    >
                                        ...
                                        ></b-form-input>
                                        <b-form-invalid-feedback id="nameCard-live-feedback">
                                            {{
